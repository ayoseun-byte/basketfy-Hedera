    ...
    const OverviewTab = () => (
        <div className="space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                <div className={`${darkMode ? 'bg-gray-800' : 'bg-white'} rounded-xl p-6 shadow-lg bg-gradient-to-br from-purple-500/10 to-pink-500/10 border ${darkMode ? 'border-gray-700' : 'border-gray-200'}`}>
                    <div className="flex items-center justify-between mb-2">
                        ...
                        <span className={`text-sm ${darkMode ? 'text-gray-400' : 'text-gray-600'}`}>Total AUM</span>
                    </div>
                    <p className="text-3xl font-bold">${(totalTVL / 1000000).toFixed(2)}M</p>
                ...
                <div className={`${darkMode ? 'bg-gray-800' : 'bg-white'} rounded-xl p-6 shadow-lg bg-gradient-to-br from-blue-500/10 to-cyan-500/10 border ${darkMode ? 'border-gray-700' : 'border-gray-200'}`}>
                    <div className="flex items-center justify-between mb-2">
                        <Users className="w-8 h-8 text-blue-500" />
                        <span className={`text-sm ${darkMode ? 'text-gray-400' : 'text-gray-600'}`}>Total Subscribers</span>
                    </div>
                ...
                <div className={`${darkMode ? 'bg-gray-800' : 'bg-white'} rounded-xl p-6 shadow-lg bg-gradient-to-br from-green-500/10 to-emerald-500/10 border ${darkMode ? 'border-gray-700' : 'border-gray-200'}`}>
                    <div className="flex items-center justify-between mb-2">
                        ...
                        <span className={`text-sm ${darkMode ? 'text-gray-400' : 'text-gray-600'}`}>Total Earnings</span>
                    </div>
                    <p className="text-3xl font-bold">${(curatorData.profile.totalEarnings / 1000).toFixed(0)}K</p>
                    <div className="flex items-center gap-2 mt-2">
                        <TrendingUp className="w-4 h-4 text-green-400" />
                        <span className="text-green-400 text-sm font-medium">+$2.1K this week</span>
                    </div>
                </div>
                ...
                <div className={`${darkMode ? 'bg-gray-800' : 'bg-white'} rounded-xl p-6 shadow-lg bg-gradient-to-br from-orange-500/10 to-red-500/10 border ${darkMode ? 'border-gray-700' : 'border-gray-200'}`}>
                    <div className="flex items-center justify-between mb-2">
                        ...
                        <span className={`text-sm ${darkMode ? 'text-gray-400' : 'text-gray-600'}`}>Avg Performance</span>
                    </div>
                    <p className="text-3xl font-bold text-green-400">+{avgPerformance.toFixed(1)}%</p>
                    <div className="flex items-center gap-2 mt-2">
            ...
            <div className={`${darkMode ? 'bg-gray-800' : 'bg-white'} rounded-xl p-6 shadow-lg border ${darkMode ? 'border-gray-700' : 'border-gray-200'}`}>
                <h2 className="text-xl font-semibold mb-6">AUM & Earnings Growth</h2>
        ...
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-6">
                {curatorData.baskets.map((basket) => (
                    <div key={basket.id} className={`${darkMode ? 'bg-gray-800' : 'bg-white'} rounded-xl p-6 shadow-lg border ${darkMode ? 'border-gray-700' : 'border-gray-200'} hover:shadow-xl transition-all cursor-pointer`}>
                        ...
                        <div className="grid grid-cols-2 gap-4 mb-4">
                            <div>
                                ...
                                <p className="text-lg font-bold">${(basket.tvl / 1000000).toFixed(2)}M</p>
                            </div>
                            <div>
                                <p className={`text-xs ${darkMode ? 'text-gray-400' : 'text-gray-500'} mb-1`}>Subscribers</p>
                                <div className="flex items-center gap-1">
                                    <Users className="w-4 h-4 text-purple-400" />
                                    <span className="text-lg font-bold">{basket.subscribers}</span>
                                </div>
                            </div>
                            <div>
                            ...
                            <div>
                                ...
                                <p className="text-lg font-bold">{basket.managementFee}%</p>
                            </div>
                        </div>
                        ...
                        <div className="flex gap-2">
                            <button
                                ...
                                className="flex-1 bg-purple-600 hover:bg-purple-700 text-white py-2 px-3 rounded-lg transition-colors text-sm font-medium flex items-center justify-center gap-1"
                            >
                                <RefreshCw className="w-4 h-4" />
                                Rebalance
                            </button>
                            <button className={`flex-1 ${darkMode ? 'bg-gray-700 hover:bg-gray-600 text-white' : 'bg-gray-200 hover:bg-gray-300 text-gray-800'} py-2 px-3 rounded-lg transition-colors text-sm font-medium flex items-center justify-center gap-1`}>
    ...
    const EarningsTab = () => (
        <div className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className={`${darkMode ? 'bg-gray-800' : 'bg-white'} rounded-xl p-6 shadow-lg border ${darkMode ? 'border-gray-700' : 'border-gray-200'}`}>
                    <h3 className="text-lg font-semibold mb-4">Management Fees</h3>
                    <p className="text-3xl font-bold text-blue-400">$45.2K</p>
                    <p className={`text-sm ${darkMode ? 'text-gray-400' : 'text-gray-600'} mt-2`}>This month: +$8.7K</p>
                </div>
                <div className={`${darkMode ? 'bg-gray-800' : 'bg-white'} rounded-xl p-6 shadow-lg border ${darkMode ? 'border-gray-700' : 'border-gray-200'}`}>
                    <h3 className="text-lg font-semibold mb-4">Performance Fees</h3>
                    <p className="text-3xl font-bold text-green-400">$39.8K</p>
                    <p className={`text-sm ${darkMode ? 'text-gray-400' : 'text-gray-600'} mt-2`}>This month: +$12.1K</p>
                </div>
                <div className={`${darkMode ? 'bg-gray-800' : 'bg-white'} rounded-xl p-6 shadow-lg border ${darkMode ? 'border-gray-700' : 'border-gray-200'}`}>
                    <h3 className="text-lg font-semibold mb-4">Available to Withdraw</h3>
                    <p className="text-3xl font-bold text-purple-400">$15.3K</p>
            ...
            <div className={`${darkMode ? 'bg-gray-800' : 'bg-white'} rounded-xl p-6 shadow-lg border ${darkMode ? 'border-gray-700' : 'border-gray-200'}`}>
                <h2 className="text-xl font-semibold mb-6">Earnings Breakdown by Basket</h2>
                <div className="space-y-4">
                    {curatorData.baskets.map((basket) => {
                        ...
                        return (
                            <div key={basket.id} className={`p-4 rounded-lg ${darkMode ? 'bg-gray-700' : 'bg-gray-50'}`}>
                                <div className="flex justify-between items-start mb-2">
                                    <h3 className="font-semibold">{basket.name}</h3>
                                    <span className="text-lg font-bold">${((mgmtFees + perfFees) / 1000).toFixed(1)}K</span>
                                </div>
                ...
                <div className={`${darkMode ? 'bg-gray-800' : 'bg-white'} rounded-xl p-6 max-w-2xl w-full max-h-[90vh] overflow-y-auto`}>
                    ...
                    <div className="space-y-4">
                        ...
                        {selectedBasket.tokens.map((token, index) => (
                            <div key={token.ticker} className={`flex items-center justify-between p-4 rounded-lg ${darkMode ? 'bg-gray-700' : 'bg-gray-50'}`}>
                    ...
                    <div className="flex gap-4 mt-6">
                        ...
                        <button className="flex-1 bg-purple-600 hover:bg-purple-700 text-white py-3 px-4 rounded-lg transition-colors">
                            Execute Rebalance
                        </button>
                    </div>
                </div>
                ...
                {activeTab === 'analytics' && (
                    <div className="space-y-6">
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                            <div className={`${darkMode ? 'bg-gray-800' : 'bg-white'} rounded-xl p-6 shadow-lg border ${darkMode ? 'border-gray-700' : 'border-gray-200'}`}>
                                <h3 className="text-xl font-semibold mb-4">Top Performing Baskets</h3>
                                    ...
                                    {curatorData.baskets
                                        ...
                                        .map((basket, index) => (
                                            <div key={basket.id} className="flex items-center justify-between">
                                                ...
                                                <span className={`font-bold ${basket.performance7d > 0 ? 'text-green-400' : 'text-red-400'}`}>
                                                    {basket.performance7d > 0 ? '+' : ''}{basket.performance7d}%
                                                </span>
                                            </div>
                                        ))}
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                            ...
                            <div className={`lg:col-span-2 ${darkMode ? 'bg-gray-800' : 'bg-white'} rounded-xl p-6 shadow-lg border ${darkMode ? 'border-gray-700' : 'border-gray-200'}`}>
                                <div className="flex items-start gap-6 mb-6">
                                    ...
                                    <div className="flex-1">
                                        ...
                                        <div className="flex items-center gap-4 mt-4">
                                            <div className="flex items-center gap-2">
                                                <Users className="w-4 h-4 text-purple-400" />
                                                <span className="font-medium">{curatorData.profile.followers} followers</span>
                                            </div>
                                            <div className="flex items-center gap-2">
                                                <Award className="w-4 h-4 text-orange-400" />
                                                <span className="font-medium">Rank #{curatorData.profile.rank}</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <button className="w-full mt-6 bg-purple-600 hover:bg-purple-700 text-white py-3 px-4 rounded-lg transition-colors font-medium">
                                    Update Profile
                                </button>
                            </div>
                            ...
                            <div className="space-y-6">
                                <div className={`${darkMode ? 'bg-gray-800' : 'bg-white'} rounded-xl p-6 shadow-lg border ${darkMode ? 'border-gray-700' : 'border-gray-200'}`}>
                                    <h3 className="text-lg font-semibold mb-4">Curator Stats</h3>
                                    <div className="space-y-4">
                                        <div>
                                            <p className={`text-sm ${darkMode ? 'text-gray-400' : 'text-gray-600'}`}>Total AUM</p>
                                            <p className="text-2xl font-bold">${(curatorData.profile.aum / 1000000).toFixed(1)}M</p>
                                        </div>
                                        <div>
                                            <p className={`text-sm ${darkMode ? 'text-gray-400' : 'text-gray-600'}`}>Active Baskets</p>
                                            <p className="text-2xl font-bold">{curatorData.baskets.length}</p>
                                        </div>
                                        <div>
                                            <p className={`text-sm ${darkMode ? 'text-gray-400' : 'text-gray-600'}`}>Total Earnings</p>
                                            <p className="text-2xl font-bold">${(curatorData.profile.totalEarnings / 1000).toFixed(0)}K</p>
                                        </div>
                                        <div>
                                        ...
                                        {[
                                            ...
                                            <div key={index} className={`flex items-center gap-3 p-3 rounded-lg ${darkMode ? 'bg-gray-700' : 'bg-gray-50'}`}>
                                                ...
                                                <div>
                                                    ...
                                                    <p className={`text-sm ${darkMode ? 'text-gray-400' : 'text-gray-600'}`}>{achievement.desc}</p>
                                                </div>
                                            </div>
                                        ))}
                                    </div>
                ...
                <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
                    <div className={`${darkMode ? 'bg-gray-800' : 'bg-white'} rounded-xl p-6 max-w-3xl w-full max-h-[90vh] overflow-y-auto`}>
                        ...
                        <div className="flex gap-4 mt-8">
                            ...
                            <button className="flex-1 bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white py-3 px-4 rounded-lg transition-all">
                                Create Basket
                            </button>
                        </div>
                    </div>
